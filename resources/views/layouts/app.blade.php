...
<body>
                ...
                <ul class="navbar-nav navbar-right">
                        ...
                        <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
                            ...
                            <div class="dropdown-list-content dropdown-list-message">
                                <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar
											text-white"> <img alt="image" src="/otika/assets/img/users/user-1.png" class="rounded-circle">
                                        ...
                                        <img alt="image" src="/otika/assets/img/users/user-2.png"
                                        ...
                                        <img alt="image" src="/otika/assets/img/users/user-5.png"
                                            class="rounded-circle">
                                        ...
                                        <img alt="image" src="/otika/assets/img/users/user-4.png"
                                            class="rounded-circle">
                                        ...
                                        <img alt="image" src="/otika/assets/img/users/user-3.png"
                                            class="rounded-circle">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image"
                                src="/otika/assets/img/user.png" class="user-img-radious-style"> <span
    ...
    <!-- JS Libraies -->
    <script src="/otika/assets/bundles/apexcharts/apexcharts.min.js"></script>
    <!-- Page Specific JS File -->
    <script src="/otika/assets/js/page/index.js"></script>
    <!-- Template JS File -->
